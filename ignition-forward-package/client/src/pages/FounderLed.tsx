...
export default function FounderLed() {
  const structuredData = {
    ...
    '@graph': [
      {
        '@type': 'Service',
        name: 'AI Enablement for Founder-Led Businesses',
        description: 'AI systems that scale founder expertise without scaling founder hours.',
        provider: { '@type': 'Organization', name: 'Ignition Forward' },
      },
      generateBreadcrumbSchema([
        { name: 'Home', url: '/' },
        { name: 'Who We Work With', url: '/#who-we-work-with' },
        { name: 'Founder-Led Businesses', url: '/founder-led' },
      ]),
    ],
  };
  ...
  return (
    <div className="overflow-hidden">
      <SEO
        title="AI for Founder-Led Businesses"
        description="Scale your expertise without scaling your calendar. AI enablement for founders who want measurable ROI, not AI theater."
        canonical="/founder-led"
      ...
      <section className="relative min-h-[60vh] flex items-center bg-navy overflow-hidden">
        ...
        <div className="container relative z-10 pt-32 pb-16">
          <div className="max-w-4xl">
            ...
            >
              Founders ready to scale their expertise without scaling their calendar — and without losing what makes the business special.
            </motion.p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-20">
        <div className="container">
          ...
          >
            <h2 className="text-navy">Ready to scale your impact?</h2>
