              ...
              <div className="flex flex-col md:flex-row items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-off-white/70 leading-relaxed mb-4">
                    Portfolio companies typically start with <Link href="/how-we-help#forward-deployed" className="text-gold underline underline-offset-2 hover:text-gold/80">Forward Deployed</Link> for quick-win operational workflows tied to value creation. For ongoing AI leadership without adding headcount, <Link href="/how-we-help#fractional-ai" className="text-gold underline underline-offset-2 hover:text-gold/80">Fractional AI Officer</Link> provides the strategic layer.
                  </p>
