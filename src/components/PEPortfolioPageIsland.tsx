            ...
            <div className="p-6 rounded-2xl bg-gold/10 border border-gold/30">
              <div className="flex flex-col md:flex-row items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-gold font-display text-lg mb-2">Recommended for PE Portfolio Companies</h3>
                  <p className="text-off-white/70 leading-relaxed mb-4">
                    Portfolio companies typically start with <a href="/how-we-help#forward-deployed" className="text-gold underline underline-offset-2 hover:text-gold/80">Forward Deployed</a> for quick-win operational workflows tied to value creation. For ongoing AI leadership without adding headcount, <a href="/how-we-help#fractional-ai" className="text-gold underline underline-offset-2 hover:text-gold/80">Fractional AI Officer</a> provides the strategic layer.
                  </p>
