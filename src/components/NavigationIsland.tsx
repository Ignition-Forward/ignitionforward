...
export default function Navigation() {
  // Astro island: no wouter Router parent. Track pathname via window.location.
  // Initialize to '/' to avoid SSR/hydration mismatch — useEffect updates it after mount.
  ...
  // No wouter route changes in Astro static — mobile menu close on hard nav happens naturally.
              ...
              <div className="container py-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <a href="/maguire" className="text-off-white/70 hover:text-off-white text-sm font-body transition-colors">
                      Our Proof
                    </a>
                    <a href="/about" className="text-off-white/70 hover:text-off-white text-sm font-body transition-colors">
                      About
                    </a>
                  </div>
