          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              >
                ...
                <a href="/contact" className="btn-gold w-full text-center flex items-center justify-center gap-2 mt-6">
                  Apply for Edge
                  <ArrowRight className="w-5 h-5" />
                </a>
              </motion.div>
        ...
        <div className="container">
          ...
          >
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="/how-we-help" className="btn-outline-navy inline-flex items-center justify-center gap-2">
