    ...
    <div className="overflow-hidden">
            ...
            {challenges.map((challenge, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-lg bg-gold/10 flex items-center justify-center mb-4 group-hover:bg-gold/20 transition-colors">
                  <challenge.icon className="w-6 h-6 text-gold/70" />
                </div>
      ...
      <section className="bg-navy py-20 md:py-24">
        <div className="container">
          ...
          >
            ...
            <h2 className="mt-4 text-2xl md:text-3xl lg:text-4xl font-display text-off-white font-semibold">AI enablement built for the GP workflow</h2>
          </motion.div>
              ...
              <div className="flex flex-col md:flex-row items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-off-white/70 leading-relaxed mb-4">
                    Most GPs start with <a href="/how-we-help#forward-deployed" className="text-gold underline underline-offset-2 hover:text-gold/80">Forward Deployed</a> to build systematic sourcing and diligence workflows. For fund-level AI strategy and LP-ready narrative, consider <a href="/how-we-help#fractional-ai" className="text-gold underline underline-offset-2 hover:text-gold/80">Fractional AI Officer</a>.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <a href="/how-we-help#forward-deployed" className="inline-flex items-center gap-2 px-4 py-2 bg-gold text-navy rounded-full text-sm font-medium hover:bg-gold/90 transition-colors">
                      Forward Deployed
      ...
      <section className="bg-off-white py-20 md:py-24">
        <div className="container">
          ...
          >
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-display text-navy font-semibold">Ready to build your edge?</h2>
